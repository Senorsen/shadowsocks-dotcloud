...
(function() {
  var Encryptor, KEY, METHOD, PORT, REMOTE_PORT, SERVER, args, config, configFromArgs, fs, getServer, http, inetAton, inetNtoa, k, net, path, server, timeout, util, v;

  config = require("./config.json");

  net = require("net");

  http = require(config.https ? 'https' : 'http');
